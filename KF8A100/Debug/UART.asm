...
;; Starting PostCode block
	.def _UART2_SendBuf_function_begin, debug, value=$
...
_00013_DS_
	CRET	
	.def _UART2_SendBuf_function_end, debug, value=$
...
;has an exit
;; Starting PostCode block
	.def _UART2_SendOneByte_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _UART2_SendOneByte_function_end, debug, value=$
...
;has an exit
;; Starting PostCode block
	.def _UART2_Init_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _UART2_Init_function_end, debug, value=$
...
;	   68+   39 =   107 instructions (  292 byte)
	...
	.type _UART2_Init,  32
	.dim _UART2_Init, 1, (_UART2_Init_function_end&0xFF00)>>8, _UART2_Init_function_end&0xFF,0,11,0,38 , 1, 1
	.type _UART2_SendOneByte,  32
	.dim _UART2_SendOneByte, 1, (_UART2_SendOneByte_function_end&0xFF00)>>8, _UART2_SendOneByte_function_end&0xFF,0,46,0,50 , 1, 1
	.type _UART2_SendBuf,  32
	.dim _UART2_SendBuf, 1, (_UART2_SendBuf_function_end&0xFF00)>>8, _UART2_SendBuf_function_end&0xFF,0,58,0,66 , 1, 1
