...
;***
;entry:  _PORT_Init	;Function start
; 2 exit points
;has an exit
;; Starting PostCode block
	.def _PORT_Init_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _PORT_Init_function_end, debug, value=$

; exit point of _PORT_Init
...
;	   71+   54 =   125 instructions (  358 byte)

	.type _delay_ms,  32
	.dim _delay_ms, 1, (_delay_ms_function_end&0xFF00)>>8, _delay_ms_function_end&0xFF,0,3,0,12 , 1, 1
	.type _PORT_Init,  32
	.dim _PORT_Init, 1, (_PORT_Init_function_end&0xFF00)>>8, _PORT_Init_function_end&0xFF,0,14,0,33 , 1, 1
