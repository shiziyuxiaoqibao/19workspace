...
;; Starting PostCode block
	.def _CAN_UnsetITStatus_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _CAN_UnsetITStatus_function_end, debug, value=$
...
;   r0x101F
;; Starting PostCode block
	.def _CAN_SetITStatus_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _CAN_SetITStatus_function_end, debug, value=$
...
;   r0x1020
;; Starting PostCode block
	.def _CAN_ClearITStatus_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _CAN_ClearITStatus_function_end, debug, value=$
...
;   r0x1021
;; Starting PostCode block
	.def _CAN_GetITStatus_function_begin, debug, value=$
...
_00148_DS_
	CRET	
	.def _CAN_GetITStatus_function_end, debug, value=$
...
;   r0x102B
;; Starting PostCode block
	.def _CAN_Receive_Message_Configuration_function_begin, debug, value=$
...
;   r0x1036
;; Starting PostCode block
	.def _CAN_Transmit_Message_function_begin, debug, value=$
...
_00072_DS_
	CRET	
	.def _CAN_Transmit_Message_function_end, debug, value=$
...
;   r0x103B
;; Starting PostCode block
	.def _CAN_Init_function_begin, debug, value=$
...
;	::->op : ENDFUNCTION
	CRET	
	.def _CAN_Init_function_end, debug, value=$
...
;   r0x1048
;; Starting PostCode block
	.def _CAN_IDFilterConfig_function_begin, debug, value=$
...
_00024_DS_
	CRET	
	.def _CAN_IDFilterConfig_function_end, debug, value=$
...
;	 1612+  985 =  2597 instructions ( 7164 byte)
	...
	.type _CAN_IDFilterConfig,  32
	.dim _CAN_IDFilterConfig, 1, (_CAN_IDFilterConfig_function_end&0xFF00)>>8, _CAN_IDFilterConfig_function_end&0xFF,0,14,0,80 , 1, 1
	.type _CAN_Init,  32
	.dim _CAN_Init, 1, (_CAN_Init_function_end&0xFF00)>>8, _CAN_Init_function_end&0xFF,0,93,0,120 , 1, 1
	.type _CAN_Transmit_Message,  32
	.dim _CAN_Transmit_Message, 1, (_CAN_Transmit_Message_function_end&0xFF00)>>8, _CAN_Transmit_Message_function_end&0xFF,0,129,0,201 , 1, 1
	.type _CAN_Receive_Message_Configuration,  32
	.dim _CAN_Receive_Message_Configuration, 1, (_CAN_Receive_Message_Configuration_function_end&0xFF00)>>8, _CAN_Receive_Message_Configuration_function_end&0xFF,0,210,1,32 , 2, 1
	.type _CAN_GetITStatus,  32
	.dim _CAN_GetITStatus, 1, (_CAN_GetITStatus_function_end&0xFF00)>>8, _CAN_GetITStatus_function_end&0xFF,1,41,1,47 , 1, 1
	.type _CAN_ClearITStatus,  32
	.dim _CAN_ClearITStatus, 1, (_CAN_ClearITStatus_function_end&0xFF00)>>8, _CAN_ClearITStatus_function_end&0xFF,1,55,1,58 , 1, 1
	.type _CAN_SetITStatus,  32
	.dim _CAN_SetITStatus, 1, (_CAN_SetITStatus_function_end&0xFF00)>>8, _CAN_SetITStatus_function_end&0xFF,1,66,1,70 , 1, 1
	.type _CAN_UnsetITStatus,  32
	.dim _CAN_UnsetITStatus, 1, (_CAN_UnsetITStatus_function_end&0xFF00)>>8, _CAN_UnsetITStatus_function_end&0xFF,1,78,1,81 , 1, 1
